...
struct RankingConfig {
    ...
    std::unordered_map<std::string, float> fieldBoosts = {
        {"title", 2.0f}, {"content", 1.0f}, {"tags", 1.5f}, {"description", 1.2f}};
...
public:
     ...
     */
    float calculateTFIDF(const std::string& term, float termFrequency,
     ...
     */
    void updateTermFrequencies(const std::string& documentText, const std::string& documentId);
