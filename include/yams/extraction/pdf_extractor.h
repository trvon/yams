...
public:
     ...
     */
    std::vector<std::string> supportedMimeTypes() const {
     ...
     */
    Result<ExtractionResult> extractRange(const std::filesystem::path& path, 
...
private:
    ...
    struct PdfPage {
        ...
        PdfPage(PdfPage&& other) noexcept 
            : page(other.page), textPage(other.textPage) { 
            other.page = nullptr;
