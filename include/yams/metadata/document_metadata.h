...
struct SearchResult {
    ...
    std::optional<double> vectorScore;      ///< Contribution from base vector/semantic search
    std::optional<double> graphVectorScore; ///< Contribution from graph-expanded vector search
    std::optional<double> keywordScore;     ///< Contribution from base FTS5/keyword search
    std::optional<double> graphTextScore;   ///< Contribution from graph-expanded text search
    ...
    std::optional<double> topologyScore; ///< Contribution from topology candidate-rescue evidence
};
