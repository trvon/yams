...
public:
     ...
     */
    template <typename... Args> Result<void> bindAll(Args&&... args) {
...
public:
     ...
     */
    template <typename Func> Result<void> transaction(Func&& func) {
...
private:
    enum class QueryType { None, Select, Insert, Update, Delete };
