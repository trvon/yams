...
public:
    ...
    [[nodiscard]] Result<void> store(std::string_view hash, std::span<const std::byte> data) override;
    ...
    // Async operations
    std::future<Result<void>> storeAsync(std::string_view hash, std::span<const std::byte> data) override;
     ...
     */
    [[nodiscard]] Result<void> compressExisting(
     ...
     */
    [[nodiscard]] bool waitForAsyncOperations(
