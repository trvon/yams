...
constexpr const char* contentStoreErrorToString(ContentStoreError error) {
    switch (error) {
        case ContentStoreError::None:
            return "No error";
        case ContentStoreError::FileNotFound:
            return "File not found";
        case ContentStoreError::PermissionDenied:
            return "Permission denied";
        case ContentStoreError::StorageFull:
            return "Storage full";
        case ContentStoreError::CorruptedContent:
            return "Corrupted content";
        case ContentStoreError::HashMismatch:
            return "Hash mismatch";
        case ContentStoreError::InvalidHash:
            return "Invalid hash";
        case ContentStoreError::InvalidMetadata:
            return "Invalid metadata";
        case ContentStoreError::NetworkError:
            return "Network error";
        case ContentStoreError::OperationCancelled:
            return "Operation cancelled";
        case ContentStoreError::OperationInProgress:
            return "Operation in progress";
        case ContentStoreError::TooManyOperations:
            return "Too many concurrent operations";
        case ContentStoreError::CompressionError:
            return "Compression error";
        case ContentStoreError::DecompressionError:
            return "Decompression error";
        case ContentStoreError::SerializationError:
            return "Serialization error";
        case ContentStoreError::DeserializationError:
            return "Deserialization error";
        case ContentStoreError::IntegrityCheckFailed:
            return "Integrity check failed";
        case ContentStoreError::UnsupportedOperation:
            return "Unsupported operation";
        case ContentStoreError::InvalidConfiguration:
            return "Invalid configuration";
        case ContentStoreError::Unknown:
...
public:
    ...
    ContentStoreException(ContentStoreError error, const std::string& message,
        ...
        : std::runtime_error(message), error_(error), contentHash_(hash) {}
...
public:
    StorageFullException(const std::string& message, uint64_t availableBytes,
        ...
        : ContentStoreException(ContentStoreError::StorageFull, message),
          availableBytes_(availableBytes), requiredBytes_(requiredBytes) {}
...
public:
    HashMismatchException(const std::string& message, const std::string& expectedHash,
        ...
        : ContentStoreException(ContentStoreError::HashMismatch, message, expectedHash),
          expectedHash_(expectedHash), actualHash_(actualHash) {}
...
constexpr ContentStoreError toContentStoreError(ErrorCode error) {
    switch (error) {
        ...
        case ErrorCode::FileNotFound:
            return ContentStoreError::FileNotFound;
        case ErrorCode::PermissionDenied:
            return ContentStoreError::PermissionDenied;
        case ErrorCode::CorruptedData:
            return ContentStoreError::CorruptedContent;
        case ErrorCode::StorageFull:
            return ContentStoreError::StorageFull;
        case ErrorCode::NetworkError:
            return ContentStoreError::NetworkError;
        case ErrorCode::HashMismatch:
            return ContentStoreError::HashMismatch;
        case ErrorCode::OperationCancelled:
            return ContentStoreError::OperationCancelled;
        case ErrorCode::OperationInProgress:
            return ContentStoreError::OperationInProgress;
        default:
            return ContentStoreError::Unknown;
    }
}
