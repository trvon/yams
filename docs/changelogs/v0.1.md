# Changelog Archive: v0.1.x Series
...
- **Task Tracking System**: Comprehensive benchmark and test enhancement tracking
  - delivery documentation structure for systematic improvement
...
- **Build System Enhancements**:
  ...
  - BUILD.md documentation for building with GNU toolchain
- **Search Improvements**:
...
### Fixed
  - Proper handling of hyphens in queries like "task-6", "task-4", "feature-123"
