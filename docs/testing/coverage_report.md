...
| `src/integrity/` | **46.4%** (512/1103) | 74.3% (78/105) | 20.3% (280/1381) | 5 |
...
| `MigrationManager`, `YamsMetadataMigrations` | `include/yams/metadata/migration.h`, `src/metadata/migration.cpp` | `tests/unit/metadata/database_catch2_test.cpp`, `tests/unit/metadata/metadata_schema_catch2_test.cpp` | Schema-version hash verification (v16, v21, v31), all built-in migrations applied, CRUD + FTS + stats + cascade post-migration schema integrity, failed-migration error propagation with version not advanced, and successful rollback restores prior version are covered. Remaining: none. |
