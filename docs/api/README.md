...
- For AI / tool integrations, use [MCP tools](mcp_tools.md) (see also the [MCP setup guide](../user_guide/mcp.md)).
- For CLI automation, see the [CLI reference](../user_guide/cli.md).
