...
public:
    ...
    /// <param name="dataset">The attributes of the second point</param>
    /// <param name="distanceFunction">Defines the type of distance measure to use : Euclidean,
    /// Manhattan ,..</param> <param name="minPoints">Min Points in the cluster</param> <param
    /// name="minClusterSize">The minimum number of points which a cluster needs to be a valid
    /// cluster</param>
