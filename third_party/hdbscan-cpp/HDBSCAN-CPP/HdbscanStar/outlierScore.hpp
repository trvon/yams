#pragma once
/// <summary>
/// Simple storage class that keeps the outlier score, core distance, and id (index) for a single
/// point. OutlierScores are sorted in ascending order by outlier score, with core distances used to
/// break outlier score ties, and ids used to break core distance ties.
/// </summary>
class outlierScore {
private:
    double coreDistance;
