// Catch2 replacement for tests/common/plugins.h.
// Provides a dlopen/dlclose RAII helper and a plugin-missing skip macro that
// uses Catch2's SKIP(...) instead of GTEST_SKIP().
#pragma once
