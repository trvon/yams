...
TEST_CASE("SymbolExtractorPlugins.RustAndGoAndJS", "[plugin][symbolextractorplugins]") {
...
TEST_CASE("SymbolExtractorPlugins.ExtractMultipleSymbols", "[plugin][symbolextractorplugins]") {
    auto plug = loadPlugin();
    REQUIRE(plug.has_value());
...
TEST_CASE("SymbolExtractorPlugins.PythonClassExtraction", "[plugin][symbolextractorplugins]") {
    auto plug = loadPlugin();
    REQUIRE(plug.has_value());
...
TEST_CASE("SymbolExtractorPlugins.ErrorHandling", "[plugin][symbolextractorplugins]") {
    auto plug = loadPlugin();
    REQUIRE(plug.has_value());
