...
TEST_CASE_METHOD(PdfSearchSmoke, "PdfKeywordSearchFindsGeneratedToken", "[smoke][pdfsearchsmoke]") {
    ...
    if (!got) {
        SKIP("SearchService degraded on this runner; skipping PDF search smoke");
    }
