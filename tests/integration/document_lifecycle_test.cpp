...
TEST_F(DocumentLifecycleTest, LargeScaleOperations) {
    ...
    std::cout << "Added " << numDocs << " documents in " << addDuration.count() << "ms" << std::endl;
    ...
    std::cout << "Searched " << numDocs << " documents in " << searchDuration.count() << "ms" << std::endl;
    ...
    std::cout << "Updated metadata for " << numDocs << " documents in " 
              << updateDuration.count() << "ms" << std::endl;
}
