...
def main() -> int:
    ...
    required_release = (
        ...
        "arch_base_image: archlinux/archlinux:latest",
        "arch_base_image: ghcr.io/menci/archlinuxarm@sha256:",
        '--build-arg "ARCH_BASE_IMAGE=${{ matrix.arch_base_image }}"',
        "ARCH_BASE_IMAGE: ${{ matrix.arch_base_image }}",
